...
pygame.display.set_caption("Kare Yakalamaca")



arkaplan = pygame.image.load("Resimler/arkaplanDers2.jpg").convert_alpha()
kareResim = pygame.image.load("Resimler/kare.jpg").convert_alpha()
dusenKare = pygame.image.load("Resimler/kare2.jpg").convert_alpha()
yakalamaSesi = pygame.mixer.music.load("Müzik/yakalama.wav")
