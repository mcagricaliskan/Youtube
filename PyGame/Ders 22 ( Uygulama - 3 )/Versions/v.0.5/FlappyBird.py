...
class Game():
    ...
    def GameLoop(self):
        ...
        for Pipes in self.PipeList:
            ...
            self.Result = self.get_mask(self.BirdMid,self.BirdX,self.BirdY,Pipes.PipeGreen,Pipes.PipeX,Pipes.PipeY)
            self.Result2 = self.get_mask(self.BirdMid, self.BirdX, self.BirdY, Pipes.PipeUpper, Pipes.PipeX, Pipes.PiperUpperY)
